...
const translations = {
  en: {
    ...
    // Contact,
    mainTitle: 'Contact',
    desc: 'If you have any inquiries, suggestions to improve the experience, error reports, business proposals, or any matter related to the content of this website, you can contact us via the following email address:',
  ...
  es: {
    ...
    // Contact,
    mainTitle: 'Contact',
    desc: 'Si tienes alguna consulta, sugerencias para mejorar la experiencia, reportes de errores, propuestas comerciales, o cualquier asunto relacionado con el contenido del sitio web, puedes comunicarte a través del siguiente correo electrónico:',
  ...
  pt: {
    ...
    // Contact,
    mainTitle: 'Contact',
    desc: 'Se você tiver alguma dúvida, sugestão para melhorar a experiência, relato de erros, proposta comercial ou qualquer assunto relacionado ao conteúdo deste site, pode entrar em contato através do seguinte e-mail:',
