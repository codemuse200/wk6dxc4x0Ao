...
const translations = {
  en: {
    ...
    ppdesc2: `We do not collect personal data from users. No login or account creation is required to access the features. Basic, anonymized analytics may be used to improve functionality (e.g., tool usage frequency), but no personally identifiable information is tracked. For more information, please refer to our <a href="/privacy-policy/"> Privacy Policy</a>.`,
