...
const translations = {
  en: {
    ...
    // Tap Tempo...
    resetButton: "RESET",
    txtTapSecondary: "Or press SPACE",
  },
  es: {
    ...
    txtTapSecondary: "O presiona ESPACIO",
  },
  pt: {
    menuMainA1: "Piano Completo", 
    ...
    // Tap Tempo...
    resetButton: "REINICIAR",
    txtTapSecondary: "Ou aperte ESPAÇO",
  },    
}
...
function changeLanguage(langparameter) {
  ...
  if (!document.getElementById('txtTapScreen').classList.contains('hasBPM')) {
    document.getElementById('txtTapScreen').textContent = getTranslatedText("tap");
    //document.querySelector(".tempoDisplay").textContent = getTranslatedText("tempo");
    //document.querySelector(".countDisplay").textContent = getTranslatedText("count");
  }/* else {
    document.querySelector(".tempoDisplay").textContent = getTranslatedText("tempo");
    document.querySelector(".countDisplay").textContent = getTranslatedText("count");
  }*/
...
function updateTitleTab() {
  let titleTab = {
    en: "Tap n' Tempo - Akordify",
    es: "Tap & Tempo - Akordify",
    pt: "Tap & Tempo - Akordify",
  }
